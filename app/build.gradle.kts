...
dependencies {
    ...
    // =====================================================
    // ARTIFICIAL INTELLIGENCE - OLLAMA LOCAL LLM
    // =====================================================
    
    // OkHttp for Ollama API communication (already included above)
    // Moshi for JSON parsing (already included above)
    
    // ML Kit for on-device translation (optional)
